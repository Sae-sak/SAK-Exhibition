  ...
  return (
    <div className="container col-center py-8 h-screen">
      ...
      >
        ...
        >
          <span className="font-accent">‘Overseer’</span>는 단어가 담은 뜻
          그대로 감독이자 관찰자라는 뜻을 지니고 있다. 도면을 그릴 때 가장 먼저
          기준이 되는 ‘축’을 정하게 되면, 바탕에 그려지는 축과 기준선은 첫
          레이어인 ‘그리드’를 형성한다. 우리는 그리드를 체스판으로 빗대어 지역과
          도시를, 한 명 한 명의 생각과 가치관이 담긴 건축물들을 체스 말로
          표현하였다. 체스의 한 수를 두는 자들이 Overseer인 우리들이다. 도시,
          동네, 공간의 강점과 특이점, 문제점 등을 하나하나 세세하게 관찰,
          감독한다. 그리고, 마침내. 본인이 들어선 그 게임을 이기는 ‘한 수’를
          배워나간다.
        </motion.p>
      </motion.div>
    </div>
